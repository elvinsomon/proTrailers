        ...
        <nav class="flex items-center justify-between flex-wrap bg-blue-900 p-6 shadow-xl">
			...
			<div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
				...
				<div>
					<a
						href="{{ url('/') }}"
						class="inline-block text-sm px-4 py-2 leading-none border rounded transition duration-200 ease-in-out transform font-bold hover:scale-110 bg-white   hover:border-transparent hover:text-gray-700 lg:mt-0 items-center mr-3"
                        >Ver Galería
                    </a>
                </div>
                <div>
                    ...
                    @else
                            <div>
                                <a class="inline-block text-sm px-4 py-2 leading-none border rounded transition duration-200 ease-in-out transform hover:scale-110 hover:font-bold text-white border-white hover:border-transparent hover:text-gray-700 lg:mt-0 items-center" href="{{ route('logout') }}"
